c Original code from https://www.ngdc.noaa.gov/IAGA/vmod/igrf13.f.
c Modified by Christopher Wingard using the gist produced by 
c Dr. Jongrae Kim (https://gist.github.com/myjr52/62ca6ffc3e9c78ea0411)
c as an example for how to use igrf12.f in python.
...
c
c-----------------------------------------------------------------------
c Added by C. Wingard per example of Dr. Jongrae Kim.
Cf2py intent(out) x
Cf2py intent(out) y
Cf2py intent(out) z
Cf2py intent(out) f
